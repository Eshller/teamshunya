import { FACULTY_TEAM } from "@/constants";
  ...
  return (
    <>
      <div className="p-8 bg-white rounded-lg shadow dark:bg-gray-800">
        <p className="uppercase mb-5 text-3xl font-bold text-center text-gray-800 dark:text-white">
          Faculty
        </p>
        ...
        <div className="flex justify-center h-full">
          <div className="flex flex-wrap justify-center border-red-800">
            ...
            {FACULTY_TEAM?.slice(1).map((team: any) => (
              <div
